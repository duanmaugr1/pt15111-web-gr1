...
$typeId = isset($_GET['typeSearch']) ? $_GET['typeSearch'] : "";
$placeId = isset($_GET['placeSearch']) ? $_GET['placeSearch'] : "";
...
if ($keyword2 !== ""){
    $foodQuery = "select * from foods where name like '%$keyword2%'";
}
                                        ...
                                        <div class="fdbox">
                                            <?php foreach ($foods as $key => $food):?>
                                                <div class="featured_box_wrap">
                                                    <div class="featured_box">
                                                        <div class="featured_box_img">
                                                            <a href="detail.php?id=<?= $food['id'] ?>"><img style="width: 420px; height: 220px;" src="<?= BASE_URL . $food['image'] ?>" alt="" /></a>
                                                        </div>
