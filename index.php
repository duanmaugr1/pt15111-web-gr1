										...
										<div class="fdbox">
											<?php foreach ($foods as $food) : ?>
												<div class="featured_box_wrap">
													<div class="featured_box" style="height: 470px;">
														<div class="featured_box_img">
															<a href="detail.php?id=<?= $food['id'] ?>"><img src="<?= BASE_URL . $food['image'] ?>" alt="" /></a>
														</div>
